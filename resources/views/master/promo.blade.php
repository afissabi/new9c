    ...
    <div class="card-header pt-10" style="background: #fff;">
        <div class="d-flex align-items-center">
            ...
            <div class="d-flex flex-column">
                <h2 class="mb-1">Data Promo Klinik</h2>
            </div>
        </div>
        ...
        <div class="modal-content" style="width: 125%;">
            ...
            <div class="modal-body">
                <form method="post" class="kt-form kt-form--label-right" id="form">
                    <div class="row mb-10">
                        <label class="col-lg-3 col-form-label text-lg-end required">Judul Promo :</label>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="judul" placeholder="Judul Promo">
                        </div>
                    </div>
                    <div class="row mb-10">
                        <label class="col-lg-3 col-form-label text-lg-end required">Gambar Promo :</label>
                        <div class="col-lg-4">
                            <div class="mt-1">
                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{ asset('img/web/default.jpg' )}})">
                                    <div class="image-input-wrapper" style="background-image: url();width: 150px !important;height: 167px !important;"></div>
                    ...
                    <div class="row mb-10">
                        <label class="col-lg-3 col-form-label text-lg-end required">Isi Promo :</label>
                        <div class="col-lg-9">
                            <textarea class="form-control form-control-solid" rows="3" name="isi" placeholder="Isi Promo"></textarea>
                        </div>
                    </div>
                    <div class="row mb-10">
                        <label class="col-lg-3 col-form-label text-lg-end required">Tarif Promo :</label>
                        <div class="col-lg-6">
                            <input type="text" class="form-control price" name="harga" placeholder="Tarif Promo">
                        </div>
                    </div>
                    <div class="row mb-10">
                        <label class="col-lg-3 col-form-label text-lg-end required">Tanggal Berlaku :</label>
                        <div class="col-lg-3">
        ...
        <div class="modal-content" style="width: 125%;">
            ...
            <div class="modal-body">
                <form method="post" class="kt-form kt-form--label-right" id="formedit">
                    <input type="hidden" class="form-control" id="id_promo" name="id_promo">
                    <div class="row mb-10">
                        <label class="col-lg-3 col-form-label text-lg-end required">Judul Promo :</label>
                        <div class="col-lg-6">
                    ...
                    <div class="row mb-10">
                        <label class="col-lg-3 col-form-label text-lg-end required">Isi Promo :</label>
                        <div class="col-lg-9">
                            <textarea class="form-control form-control-solid" rows="3" name="isi" id="isi" placeholder="Isi Promo"></textarea>
                        </div>
                    </div>
                    <div class="row mb-10">
                        <label class="col-lg-3 col-form-label text-lg-end required">Tarif Promo :</label>
                        <div class="col-lg-6">
                            <input type="text" class="form-control price" id="harga" name="harga" placeholder="Tarif Promo">
                        </div>
                    </div>
                    <div class="row mb-10">
                        <label class="col-lg-3 col-form-label text-lg-end required">Tanggal Berlaku :</label>
...
<div class="modal fade" tabindex="-1" id="kt_klinik" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-750px">
        <div class="modal-content" style="width: 125%;">
            <div class="modal-header" style="background: #f1faff;">
                <h5 class="modal-title">Mapping Promo Klinik</h5>
                <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                    <span class="svg-icon svg-icon-2x"></span>
                </div>
            </div>
            <div class="modal-body">
                <form method="post" class="kt-form kt-form--label-right" id="formklinik">
                    <input type="hidden" class="form-control" id="id_promo_klinik" name="id_promo">
        ...
        <div class="modal-content" style="width: 125%;">
            ...
            <div class="modal-body">
                <form method="post" class="kt-form kt-form--label-right" id="formbayar">
                    <input type="hidden" class="form-control" id="id_promo_bayar" name="id_promo">
                    <div class="row mb-10">
...
<script>
    ...
    $(function () {
        tabelData = $('#table').DataTable({
            ...
            ">",
            ajax: {
                url : "{{ url('promo-master/datatable') }}",
    ...
    $('#table').on('click', '.edit', function (e) {
        ...
        $.ajax({
            ...
            success: function(msg){
                ...
                if(msg){
                    $('#id_promo').val(msg.edit.id_m_promo);
                    $('#judul').val(msg.edit.judul_promo);
                    $('#isi').val(msg.edit.isi_promo);
                    $('#harga').val(msg.harga);
    ...
    $('#table').on('click', '.metode', function (e) {
        ...
        $.ajax({
            ...
            success: function(msg){
                // Add response in Modal body
                if(msg){
                    $('#id_promo_bayar').val(msg.edit.id_m_promo);
                }
                // Display Modal
            ...
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                        type:'POST',
                        url: "{{ url('promo-master/tambah-metode-bayar') }}",
                        data: formData,
                        contentType: false,
                        processData: false,
                    })
    ...
    function hapusMetode(id_metode) {
        swal.fire({
            title: "Apa Anda Yakin?",
            text: "Menghapus Metode Pembayaran Promo Tersebut",
            type: "warning",
            showCancelButton: true,
            confirmButtonText: "Ya, Hapus!",
            closeOnConfirm: false,
            ...
            if (result.value) {
                $.ajax({
                    type: "post",
                    url: "{{ url('promo-master/destroyMetode') }}",
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                    dataType: "json",
                    data: {
                        id : id_metode
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response){
                    ...
                    $('#id_promo_klinik').val(response.id_promo);
                }
                // Display Modal
    ...
    $(function () {
        $("#formklinik").submit(function(e) {
            ...
            swal.fire({
                title: "Apa Anda Yakin?",
                text: "Menambah Promo ke Klinik Tersebut ?",
                type: "warning",
                showCancelButton: true,
                confirmButtonText: "Ya, Tambah!",
                closeOnConfirm: false,
                ...
                if (result.value) {
                    $.ajax({
                        headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                        type:'POST',
                        url: "{{ url('promo-master/mapping-klinik') }}",
                        data: formData,
                        contentType: false,
                        processData: false,
                    })
    ...
    function Aktif(id_data) {
        swal.fire({
            title: "Apa Anda Yakin?",
            text: "Mengubah Status Promo Menjadi Aktif ?",
            type: "warning",
            showCancelButton: true,
    ...
    function TidakAktif(id_data) {
        swal.fire({
            title: "Apa Anda Yakin?",
            text: "Mengubah Status Promo Menjadi Tidak Aktif ?",
            type: "warning",
            showCancelButton: true,
            confirmButtonText: "Ya, Ubah!",
            closeOnConfirm: false,
            ...
            if (result.value) {
                $.ajax({
                    type: "post",
                    url: "{{ url('promo-master/tidak-aktif') }}",
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                    dataType: "json",
                    data: {
                        id : id_data
