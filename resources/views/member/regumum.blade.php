...
<script>
    ...
    function klinik() {
        ...
        $.ajax({
            url: "{{ url('member-area/get-reg-klinik') }}",
            type: "get",
    ...
    $('#pilihklinik').on('click', '.layanan', function (e) {
        ...
        $.ajax({
            url: "{{ url('member-area/get-reg-layanan') }}",
            type: "get",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            data: {
                klinik : klinik,
    ...
    $('#pilihklinik').on('click', '.tanggal', function (e) {
        ...
        // $('#loading_tanggal').modal('show');
        $.ajax({
            url: "{{ url('member-area/get-reg-tanggal') }}",
            type: "get",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            data: {
                klinik : klinik,
    ...
    $('#pilihtanggal').on('click', '.jam', function (e) {
        ...
        // $('#loading_tanggal').modal('show');
        $.ajax({
            url: "{{ url('member-area/get-reg-jam') }}",
            type: "get",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            data: {
                klinik : klinik,
    ...
    $('#pilihjam').on('click', '.register', function (e) {
        ...
        // $('#loading_tanggal').modal('show');
        $.ajax({
            url: "{{ url('member-area/get-layanan-register') }}",
            type: "get",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            data: {
                layanan : layanan,
    ...
    function pilihMetode() {
        $.ajax({
            url: "{{ url('member-area/get-metode-bayar-layanan') }}",
            type: "get",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            data: {
                tipe : $('#tipe_bayar').val(),
    ...
    $(function () {
        $("#form").submit(function(e) {
            ...
            swal.fire({
                title: "Anda akan mendaftarkan pegawai",
                ...
                if (result.value) {
                    $.ajax({
                        headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                        type:'POST',
                        url: "{{ url('member-area/simpan-register/layanan') }}",
                        data: formData,
                        contentType: false,
                        processData: false,
                    })
                    .done(function(hasil) {
                        ...
                        if (hasil.status == true) {
                            ...
                            swal.fire({
                                ...
                                window.location.href = `{{ url('member-area/thanks') }}`
                            });
                        } else {
                            title = "Gagal!";
                            icon = "error";
