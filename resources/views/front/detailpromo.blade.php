        ...
        <div class="row g-5">
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-5">
                    <h1 class="mb-0">{{ $promo->judul_promo }}</h1>
                </div>
                <p class="mb-4">{!! $promo->isi_promo !!}</p>
                ...
                <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.6s">
                    ...
                    <div class="ps-4">
                        ...
                        <h4 class="text-primary mb-0">031 591 77353</h4>
                    </div>
                </div>
            ...
            <div class="col-lg-5" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 rounded wow zoomIn" data-wow-delay="0.9s" src="{{ asset('img/promo/' . $promo->gambar) }}" style="object-fit: cover;">
                </div>
            </div>
        </div>
