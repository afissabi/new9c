...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" style="margin-top:10px">
    <div class="container py-5">
        <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
            <h5 class="fw-bold text-primary text-uppercase">Event Kami</h5>
            <p>Berikut adalah beberapa event atau kegiatan yang diselenggarakan oleh Klinik 9COrthodontics</p>
        </div>
        <div class="row g-5">
            <!-- Blog list Start -->
            <div class="col-lg-8">
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="section-title text-center position-relative pb-3 mb-4 mx-auto" style="max-width: 600px;">
            <h5 class="fw-bold text-primary text-uppercase">Galeri Event</h5>
        </div>
