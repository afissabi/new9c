...
<head>
    <base href="../../../">
    <title>9Corthodontics Admin-Area</title>
    <meta charset="utf-8" />
            ...
            <div class="row">
                ...
                <div class="col-md-4" style="background: #ffffff78;padding: 15px;border-radius: 10px;">
                    <div class="mb-10" style="justify-content: center; text-align: center;">
                        <h5>- HALAMAN ADMIN 9CORTHODONTICS -</h5>
                    </div>
                    <form class="form w-100" id="form">
                        ...
                        <div class="row" style="text-align: center;">
                            <div class="col-md-6">
                                <a href="" class="btn btn-block btn-active-warning btn-hover-rise" style="width: 100%;">Lupa Password ?</a>
                            </div>
                            <div class="col-md-6">
...
<script>
    ...
    if (saveData) {
        document.querySelector('#form').addEventListener('submit', async (event) => {
            ...
            let post = await postData("{{ route('login') }}", dataForm, dataToken);
            if (post.code == 222) {
