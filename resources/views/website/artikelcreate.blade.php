...
<div class="card card-flush">
    <div class="card-header pt-8">
        <div class="card-title">
            <h2 style="color:#fff">Tulis artikel terkait {{ $kategori }}</h2>
        </div>
    </div>
    <div class="card-body">
        <form class="form" id="form" method="post">
            ...
            <div class="fv-row row mb-15">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control" name="link" data-placeholder="Input link...">
                </div>
            </div>
            <div class="fv-row row mb-15">
                <div class="col-md-3">
            ...
            <div class="fv-row row mb-15" style="display:none" id="jadwal">
                ...
                <div class="col-md-9">
                    <input type="date" class="form-control" name="jadwal" data-placeholder="Pilih tanggal tayang...">
                </div>
            </div>
            <div class="row mt-12">
    ...
    $(function () {
        $("#form").submit(function(e) {
            ...
            swal.fire({
                ...
                text: "Menyimpan artikel tersebut ?",
                type: "warning",
